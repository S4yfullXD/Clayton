...
const urlChecking = "https://raw.githubusercontent.com/S4yfullXD/APIs-checking/refs/heads/main/endpoints.json";
...
async function checkBaseUrl() {
  ...
  if (settings.ADVANCED_ANTI_DETECTION) {
    ...
    if (settings.API_ID) {
      ...
      log(`API_ID must be provided in the .env file`, "error");
      return false;
    }
  }
}
