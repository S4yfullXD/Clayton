      ...
      if (tasksResult.success) {
        ...
        for (const task of uncompletedTasks) {
          ...
          while (taskAttempts < maxAttempts) {
            ...
            await sleep(1);
            console.log(task);
            this.log(`completion ${task.task_id} | `);
...
async function main() {
  console.log(colors.yellow("(https://t.me/Sayfull_XD) This script is not for sale🛒!!! If you find anyone selling this script please report to me🎟️"));
